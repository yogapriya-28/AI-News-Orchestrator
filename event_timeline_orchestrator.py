...
st.markdown("<h1>🧭 AI News Orchestrator — PRO (Competition)</h1>", unsafe_allow_html=True)
init_db()
...
if page == "Orchestrator":
    ...
    if build_btn:
        ...
        with left:
            ...
            lang_map = {"auto":None, "english":"english","hindi":"hindi","tamil":"tamil","spanish":"spanish","french":"french","arabic":"arabic"}
